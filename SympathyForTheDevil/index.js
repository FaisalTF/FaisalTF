...
function init() {
  ...
  document.getElementById("helpButton").addEventListener("click", function() {toggleHelp(); toggleHUD();});
  document.getElementById("understandBtn").addEventListener("click", function() {toggleHelp(); toggleWarning()});
  document.getElementById("cite").addEventListener("click", toggleCitation);
  document.getElementById("help").addEventListener("click", function() {toggleWarning(); toggleHUD();});
...
function toggleWarning() {
  document.getElementById("warningView").classList.toggle("hidden");
}
